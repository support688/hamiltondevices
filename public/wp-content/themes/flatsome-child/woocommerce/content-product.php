	...
	<div class="product-small box <?php echo flatsome_product_box_class(); ?>">
		<div class="box-image">
			...
			<div class="image-tools is-small top right show-on-hover">
				...
				<a href="<?php echo site_url(); ?>?add-to-cart=<?php echo get_the_ID(); ?>" class="listing-cart"><i class="icon-shopping-cart"></i></a>
			</div>
			<div class="image-tools is-small hide-for-small bottom left show-on-hover">
				<?php do_action( 'flatsome_product_box_tools_bottom' ); ?>
				<a href="<?php the_post_thumbnail_url("full"); ?>" itemprop="image" class="fancybox listing-search" title="" ><i class="icon-search"></i></a>
			</div>
		...
		<div class="box-text <?php echo flatsome_product_box_text_class(); ?>">
			<?php
				...
				echo '<div class="price-wrapper">'	?>	<div style="text-align: center;
    color: #000;"><?php the_field ('price_text');?>&nbsp; <b style="color:#E50914;"><?php if( get_field('lowest_price') ){echo '$';}the_field ('lowest_price');?></b></div><?php ;
