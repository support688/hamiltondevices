...
<?php echo do_shortcode('[woocommerce_social_login_buttons return_url="https://hamiltondevices.com/?wc-api=auth&done=google"]'); ?>
		...
		<div class="col-2 large-6 col pb-0">
			...
			<div class="account-register-inner">
				...
				<?php echo do_shortcode( '[user_registration_form id="27723"]' ); ?>
